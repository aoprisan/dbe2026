...
/**
 * A tiny TF-IDF genre-affinity model built from the user's picks. On a
 * one-stage bill there is nothing to clash, so the model's job is discovery:
 * ranking the acts you *haven't* picked against the taste your picks describe.
 * Entirely client-side and cheap enough to recompute on demand.
 */
